...
namespace BedrockPlugins\muqsit\invmenu;

use BedrockPlugins\muqsit\invmenu\inventories\ChestInventory;
use BedrockPlugins\muqsit\invmenu\inventories\DoubleChestInventory;
use BedrockPlugins\muqsit\invmenu\inventories\HopperInventory;
